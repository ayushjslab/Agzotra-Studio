...
// src/app/(app)/(auth)/auth-code-error/page.tsx
var import_link = __toESM(require_link2());
var import_jsx_runtime = __toESM(require_jsx_runtime());
function AuthCodeError() {
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "min-h-screen flex items-center justify-center bg-[#0a0a0a] text-white p-4", children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "max-w-md w-full bg-[#111111] border border-white/10 rounded-2xl p-8 text-center shadow-2xl", children: [
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("h1", { className: "text-3xl font-bold mb-4 text-red-500", children: "Authentication Error" }),
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { className: "text-white/60 mb-8 leading-relaxed", children: "We were unable to exchange your authentication code for a session. This usually happens due to a misconfiguration in the OAuth settings." }),
    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "bg-red-500/10 border border-red-500/20 rounded-xl p-4 mb-8 text-left text-sm space-y-2", children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { className: "font-semibold text-red-400", children: "Common causes:" }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("ul", { className: "list-disc list-inside text-white/40", children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("li", { children: "Incorrect Google Client Secret in Supabase Dashboard" }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("li", { children: "Redirect URI mismatch in Google Cloud Console" }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("li", { children: "Expired authentication code (try again)" })
      ] })
    ] }),
