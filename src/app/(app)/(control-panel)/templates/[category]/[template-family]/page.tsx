        ...
        return (
            <div className="min-h-screen bg-[#09090b] text-white flex items-center justify-center p-8">
                <div className="text-center">
                    ...
                    <p className="text-neutral-500 mb-8">The template family you are looking for does not exist.</p>
                    <Link href={`/templates/${category}`} className="px-6 py-2.5 bg-white text-black font-bold rounded-full">
                        Back to Category
                    </Link>
                </div>
            </div>
            ...
            <div className="max-w-7xl mx-auto">
                <header className="mb-12 md:mb-16">
                    <div className="flex items-center gap-2 mb-4">
                        ...
                        <span className="text-sm font-bold text-purple-500 uppercase tracking-[0.2em]">{templateFamily} Family</span>
                    </div>
                    <h1 className="text-4xl md:text-6xl font-black tracking-tight mb-4">
                        {templateFamily.charAt(0).toUpperCase() + templateFamily.slice(1)} <span className="text-transparent bg-clip-text bg-linear-to-r from-white to-purple-400">Variations</span>
                    </h1>
