...
export default function Tech1({
    ...
    backgroundImage = "https://images.unsplash.com/photo-1510906594845-bc082582c8cc?q=80&w=1144&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
}: Tech1Props) {
    return (
        <div
